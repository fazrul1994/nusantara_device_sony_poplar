...
TWRP_QSEECOMD="$NAD_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/recovery/root/sbin/qseecomd
TWRP_GATEKEEPER_SERVICE="$NAD_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/recovery/root/sbin/android.hardware.gatekeeper@1.0-service-qti
TWRP_KEYMASTER_SERVICE="$NAD_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/recovery/root/sbin/android.hardware.keymaster@3.0-service-qti
...
DEVICE_ROOT="$NAD_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/
